...
This project is indexed by GitNexus as **tail-claude-gui** (1507 symbols, 3590 relationships, 124 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
